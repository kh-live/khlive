...
<div id="page">
<h2>Scheduler</h2>
Please note that no checks are done to make sure the schedule is consitent. Make sure the stop time is after the start time and that no meeting from an other congregation overlaps.<br /><br />
...
$i=0;
	...
	if (strlen($data[2])==3) $data[2]=$data[2].'0';
	if (strlen($data[3])==3) $data[3]=$data[3].'0';

...
<div id="menu"><a href="./login"><?PHP echo $lng['home'];?></a>
 <?PHP
 if ($_SESSION['type']=="user") echo ' - <a href="./listening">'.$lng['listening'].'</a> - <a href="./record">'.$lng['recordings'].'</a> - <a href="./video">Videos</a>';

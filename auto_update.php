...
cp <?PHP echo $auto_update_dir_git; ?>/*.php /var/www/kh-live/
cp <?PHP echo $auto_update_dir_git; ?>/*.css /var/www/kh-live/
cp <?PHP echo $auto_update_dir_git; ?>/.htaccess /var/www/kh-live/
